...
The purpose of this module is to provide a picklist
of OSU Buildings. We aim to use it as a dropdown for
a location taxonomy to allow us to link to the campus 
map in a structured way.

We're undecided if we'll be keeping items in this list
in perpetuity or not.

## Example Campus Map Link

``` 
University Hall (339)
https://www.osu.edu/map/building.php?building=339 
```

## Building Service

Did you know there is a building web service? 
Maybe at some point this module will be wired into that.

https://esbprd.it.ohio-state.edu/sims/Buildings

## List Snapshot (might not be current)
