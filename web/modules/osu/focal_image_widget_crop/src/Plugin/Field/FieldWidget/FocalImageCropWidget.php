...
namespace Drupal\focal_image_widget_crop\Plugin\Field\FieldWidget;
 ...
 *
 * @FieldWidget(
 *   id = "focal_image_widget_crop",
 *   label = @Translation("Focal ImageWidget crop"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class FocalImageCropWidget extends ImageCropWidget {
