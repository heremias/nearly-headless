<?php
    ...
    class BuckeyeAlertsConfigurationForm extends ConfigFormBase {
      ...
      public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $buckeye_alert_show_on_admin = $config->get('buckeye_alert_show_on_admin',false);
        ...
        $form['buckeye_alert_show_on_admin'] = array(
          '#type' => 'checkbox',
          '#title' => t('Display on admin pages'),
          '#default_value' => $buckeye_alert_show_on_admin,
        );
      ...
      public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        $config->set('buckeye_alert_show_on_admin', $form_state->getValue('buckeye_alert_show_on_admin'))->save();
